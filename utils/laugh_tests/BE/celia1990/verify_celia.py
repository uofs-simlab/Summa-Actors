...
output_variables = [nSnow, nSoil, nLayers, mLayerHeight, iLayerLiqFluxSoil, \
...
data_to_compare_path = Path("./output/summa_celia1990_G1-1_timestep.nc")
    ...
    for var in output_variables:
        try:
            ...
            for elem in range(0, len(verified_data)):
                if abs(verified_data[elem] - to_verify_data[elem]) > 0.001:
