...
#SBATCH --output=/home/kklenk/scratch/Sundials_Output_rtol1e-4_atol1e-12/slurm/slurm-%A_%a.out
...
gru_count=4000
max_job=130
summa_exe=/home/kklenk/Summa-Projects/Summa-Actors/bin/summa_sundials
